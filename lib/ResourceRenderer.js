...
export class ResourceRenderer {
  constructor(config) {
    // Use absolute path to the views directory
    ...
    console.log('[ResourceRenderer] Templates directory:', this.templatesDir);
  ...
  async render(resource, data, viewType = 'detail') {
    try {
      ...
      console.log(`[ResourceRenderer] Rendering template: ${templatePath}`);
